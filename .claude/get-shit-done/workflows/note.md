...
- **Global scope**: `/Users/terrence_tan/startups/opencode-powered-agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/terrence_tan/startups/opencode-powered-agent/.claude/notes/`)
...
2. Glob `/Users/terrence_tan/startups/opencode-powered-agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/terrence_tan/startups/opencode-powered-agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/terrence_tan/startups/opencode-powered-agent/.claude/notes/` — works in any directory
