...
<required_reading>
@/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
