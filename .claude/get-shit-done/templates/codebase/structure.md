...
- Usage: Reference from command with `@/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/terrence_tan/startups/opencode-powered-agent/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/terrence_tan/startups/opencode-powered-agent/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
