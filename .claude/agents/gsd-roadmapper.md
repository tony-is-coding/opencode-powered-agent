...
Reference full template: `/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/templates/state.md`.
