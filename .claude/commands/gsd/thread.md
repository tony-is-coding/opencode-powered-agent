...
5. Commit:
   ```bash
   node "/Users/terrence_tan/startups/opencode-powered-agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
