...
// Auth stub — original Auth module not migrated, MAAS adapter will replace this
// This stub prevents compile errors during migration; all Auth.get() calls return undefined
const Auth = {
  get: async (_id: string): Promise<any> => undefined,
  all: async (): Promise<Record<string, any>> => ({}),
  set: async (_id: string, _info: any): Promise<void> => {},
  remove: async (_id: string): Promise<void> => {},
  Info: z.any(),
}
const Installation = { VERSION: "0.1.0" }
