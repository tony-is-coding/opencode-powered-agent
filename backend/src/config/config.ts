...
// Stubs for removed modules — will be replaced during transformation phase
const Auth = { all: async () => ({} as Record<string, any>) }
const Account = {
  active: () => undefined as any,
  config: async (_id: string, _orgId: string) => undefined as any,
  token: async (_id: string) => undefined as any,
}
const Installation = { isLocal: () => false, VERSION: "0.1.0" }
const LSPServer = {} as Record<string, { id: string }>
